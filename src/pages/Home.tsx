...
import { ArrowRight, ChevronLeft, ChevronRight, Star, ShoppingBag, ShieldCheck, Sparkles } from 'lucide-react';
...
const CATEGORIES = [
  {
    ...
    description: "Executive styles from Redford & Edge for the modern professional.",
    image: formal,
  ...
  },
  {
    ...
    description: "Hooves, Campus & Sparx. Engineered for maximum durability and speed.",
    image: campus,
  ...
  },
  {
    ...
    description: "Specialized Orthocare and vibrant styles for the little ones.",
    image: sparx,
  ...
  },
  {
    ...
    description: "Reliable comfort from Paragon & Walkaroo for your everyday needs.",
    image: slippers,
        ...
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
          ...
          <div className="relative flex justify-center items-center">
            <AnimatePresence mode="wait">
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${CATEGORIES[currentIndex].color} blur-[120px] rounded-full`}></div>
                <img
            ...
            <div className="absolute -bottom-6 md:bottom-12 flex gap-4">
              <button onClick={prevSlide} className="p-4 bg-zinc-100 border hover:bg-zinc-900 hover:text-white rounded-full">
                <ChevronLeft />
              </button>
              <button onClick={nextSlide} className="p-4 bg-zinc-100 border hover:bg-zinc-900 hover:text-white rounded-full">
                <ChevronRight />
              </button>
            </div>
          </div>
          ...
          <div className="flex overflow-hidden">
            <div className="flex gap-20 animate-marquee whitespace-nowrap">
              {[...BRANDS, ...BRANDS].map((brand, idx) => (
                <span key={idx} className="text-zinc-300 text-3xl md:text-5xl font-black italic uppercase hover:text-orange-500">
                  {brand}
                </span>
              ))}
            </div>
      ...
      <div className="bg-orange-600 py-6 text-white">
        <div className="container mx-auto px-6 flex flex-wrap justify-around gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold uppercase">100% Original Brands</span>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold uppercase">Premium Orthocare</span>
          </div>
        </div>
      </div>
