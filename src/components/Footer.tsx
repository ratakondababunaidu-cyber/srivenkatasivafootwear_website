        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-16">
          ...
          <div className="space-y-5">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/srivenkatasivafootwear"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.facebook.com/share/14Wap7wkGB7/"
                target="_blank"
                rel="noreferrer"
            ...
            <ul className="space-y-3">
              {shopCategories.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className="text-zinc-500 hover:text-orange-500 text-sm flex items-center gap-1 group"
                  >
                    {item.name}
